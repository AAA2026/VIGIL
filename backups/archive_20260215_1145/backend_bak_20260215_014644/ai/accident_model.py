...
class AccidentModel:
    def __init__(self, model_path: str | None = None):
        ...
        self.model = None
        self._warned_missing_decord = False
    ...
    def predict(self, video_path: str) -> float:
        ...
        """
        if not _HAS_DECORD:
            if not self._warned_missing_decord:
                print("[ACCIDENT_MODEL] decord is not installed; crash detection is disabled.")
                self._warned_missing_decord = True
            return 0.0
