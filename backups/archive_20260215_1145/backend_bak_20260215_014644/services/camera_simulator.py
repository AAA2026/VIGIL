...
from backend.config import DEFAULT_CAMERAS, VIOLENCE_CAMERAS, CRASH_CAMERAS, PEOPLE_COUNT_CAMERAS, VIOLENCE_THRESHOLD, ACCIDENT_THRESHOLD, BASE_DIR
                ...
                if now < blocked_until:
                    ...
                    if conf >= VIOLENCE_THRESHOLD:
                        ...
                        add_incident(
                            ...
                            event_type="violence",
                            confidence=conf,
                            video_path=Path(video_abs_path).name,
